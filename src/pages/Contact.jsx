...
const Contact = () => {
  ...
  return (
    <section
      id="contact"
      className="min-h-screen py-10 px-2 sm:py-20 sm:px-6 bg-white flex items-center justify-center"
    >
      <div className="w-full max-w-md sm:max-w-xl mx-auto">
        <div className="flex justify-center mb-4 animate-bounce" data-aos="fade-down">
          <FaEnvelopeOpenText className="text-indigo-600 text-5xl drop-shadow" />
        </div>
        <h2
          className="text-2xl sm:text-3xl md:text-4xl font-bold text-indigo-700 mb-6 text-center"
          data-aos="fade-down"
        >
          Contact Us
        </h2>
